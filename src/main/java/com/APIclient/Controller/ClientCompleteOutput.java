...
public class ClientCompleteOutput {
    private String dni;
    private String name;
    private Date date;
    ...
    public ClientCompleteOutput(String dni, String name, Date date, String country, boolean premium) throws EmptyGapException, WrongArgumentExceptcion {
    ...
    public static ClientCompleteOutput getClientComplete(Client client) throws WrongArgumentExceptcion, EmptyGapException {
        return new ClientCompleteOutput(client.getDni(), client.getName(), client.getDate(), client.getCountry(), client.isPremium());
    }
